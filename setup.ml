...
(* OASIS_START *)
(* DO NOT EDIT (digest: c95382bfc1b8b82e5767921d2125a1ff) *)
(*
...
let setup_t =
  {
            ...
            [
               Executable
                 ({
                      ...
                      bs_data_files =
                        [
                           ...
                           ("certificates/server.key",
                             Some "$datadir/imaplet");
                           ("imaplet.cf", Some "$datadir/imaplet");
                           ("users", Some "$datadir/imaplet")
                        ];
                   ...
                   {exec_custom = false; exec_main_is = "imaplet.ml"});
               Executable
                 ({
                     cs_name = "imaplet_irmin_store";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "imaplet_irmin_store.ml"
                   });
               Executable
                 ({
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "imaplet_proxy.ml"})
            ];
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "2­z)w±n8i\006J\158\140«ÿL";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
